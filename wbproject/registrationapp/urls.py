...
urlpatterns = [
    ...
    path('api/drivers/', views.create_driver, name='create_driver'),
    path('api/driver/<int:driver_id>/', views.get_driver_details, name='get_driver_details'),
    path('api/driver/<int:driver_id>/update/', views.update_driver, name='update_driver'),
    path('api/driver/<int:driver_id>/delete/', views.delete_driver, name='delete_driver'),
